#!/usr/bin/env python3
"""
FatSecret polling script — User 1.
...
Credentials are read from credentials_u1.json in the same directory.
"""
...
CREDENTIALS_FILE = os.path.join(SCRIPT_DIR, "credentials_u1.json")
...
def main():
    try:
        ...
        result = {"error": "credentials_u1.json not found", "calories": 0, "protein": 0, "fat": 0, "carbs": 0}
